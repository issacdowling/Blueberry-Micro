...
Example Output:
```
{"metadata": {"core_id": "date_time_get", "friendly_name": "Date / Time Getter", "link": null, "author": null, "icon": null, "description": null, "version": 0.1, "license": "AGPLv3"}, "intents": [{"id": "getDate", "keywords": ["date", "day", "time"], "type": "get", "core_id": "date_time_get", "private": true}]}
```
